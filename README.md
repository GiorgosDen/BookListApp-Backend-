...
**!!!Note: The URL for connecting to the cluster is intentionally exposed in the server.js file to allow connection with the project's simple installation. This is "illegal" for security reasons, but it concerns a simple database (only 1 table) in Atlas, having an account from a disposable email.**
